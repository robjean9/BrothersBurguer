 ...
 * @author Rafael
 */
public class CadastroComplemento extends javax.swing.JFrame {
    private Complemento C = new Complemento();
    BdComplemento bdc = new BdComplemento();
    private boolean novo = true;
    private String preco;
    private Double precofinal;
    private boolean erro=false;
    /**
     * Creates new form CadastroComplemento
     */
    public CadastroComplemento() {
        initComponents();
        
    }
public void telaToComplemento(){
         C.setNome(tNome.getText());
         C.setPreco(Double.parseDouble(preco));      
           }
      private void produtoToTela(){
          tIdlanche.setText(Integer.toString(C.getIdcomplemento()));
          tNome.setText(C.getNome());
          tPreco.setText(Double.toString(C.getPreco()));
         }
    /**
                    ...
                    if(tNome.getText().equals("")){
                        JOptionPane.showMessageDialog(null, "PREENCHA TODOS OS CAMPOS CORRETAMENTE", "ATENÇÃO", JOptionPane.WARNING_MESSAGE);
                            ...
                            try {
                                ...
                                Logger.getLogger(CadastroComplemento.class.getName()).log(Level.SEVERE, null, ex);
                            }
                    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CadastroComplemento.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CadastroComplemento().setVisible(true);
            }
        });
    }
     ...
     */
    public void setC(Complemento C) {
        this.C = C;
        produtoToTela();
    }
     ...
     */
    public void setL(Complemento L) {
        this.C = C;
    }
}
